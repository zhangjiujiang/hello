...
async function post() {
    ...
    try {
        await _declarations_hello__WEBPACK_IMPORTED_MODULE_0__.hello.post(otp, text);
        textarea.value = "";
    } catch (error) {
...
async function load_posts() {
    ...
    let posts = await _declarations_hello__WEBPACK_IMPORTED_MODULE_0__.hello.posts(0);
...
async function set_name() {
    ...
    try {
        await _declarations_hello__WEBPACK_IMPORTED_MODULE_0__.hello.set_name(name_input.value);
        name_input.value = "";
    } catch (error) {
        alert(error);
    }
...
async function load_name() {
    ...
    let name = await _declarations_hello__WEBPACK_IMPORTED_MODULE_0__.hello.get_name();
    nameLabel.innerText = name;
}

async function load_timeline(name, str) {
    let timeline_section = document.getElementById("timelines");
    let timelines = await _declarations_hello__WEBPACK_IMPORTED_MODULE_0__.hello.timelineBy(str.toString());
...
async function load_follows() {
    let follows = await _declarations_hello__WEBPACK_IMPORTED_MODULE_0__.hello.follows();
    ...
    for (let i = 0; i < follows.length; i++) {
        let nameBy = await _declarations_hello__WEBPACK_IMPORTED_MODULE_0__.hello.nameBy(follows[i].toString());
